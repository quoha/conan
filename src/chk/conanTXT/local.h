 ...
 *
 *************************************************************************/
#ifndef conan_src_chk_cgi00000_local_H
#define conan_src_chk_cgi00000_local_H
 ...
 */
CuSuite *GetSuiteTXT();
CuSuite *GetSuiteTXTConcat();
CuSuite *GetSuiteTXTCompare();
